use bevy::ecs::{entity::{ContainsEntity, Entity}, system::{Commands, Query, ResMut}};
...
pub fn update(
    ...
    mut log_lines: ResMut<my_world::resource::log_buffer::LogBuffer>,
) {
...
pub fn handle_server_ssh_messages(
    mut log: ResMut<my_world::resource::log_buffer::LogBuffer>,
    servers_list: Query<&my_world::component::servers::Servers>,
