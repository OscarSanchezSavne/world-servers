use bevy::prelude::*;
use crate::{core::server::manager, visualizer::my_world::{self, global::components::AppState}};
...
pub fn run(
    ...
    for row in 0..rows {
        ...
        for col in 0..cols {
            ...
            cells.push(my_world::cell::components::Cell {
    ...
    {
        let entity= my_world::cell::entity::create(
    ...
    world_data.index_cells_sort = my_world::grid::utilities::reorder_from_center(&indices);
