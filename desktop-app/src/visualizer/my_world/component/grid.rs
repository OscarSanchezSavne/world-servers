...
pub struct Grid{
    pub cols: usize,
    pub rows: usize,
    pub matrix_cells: Vec<Vec<my_world::component::cell::Cell>>,
    pub expanded: bool,
...
impl Grid {
    ...
    pub fn create() -> Self {
        ...
        let mut matrix_cells:Vec<Vec<my_world::component::cell::Cell>> = vec![];
        ...
        for row in 0..rows {
            ...
            for col in 0..cols {
                ...
                elements.push(my_world::component::cell::Cell{
    ...
    pub fn expand_border(&mut self) {
        ...
        for row in self.matrix_cells.iter_mut() {
            ...
            row.insert(0, my_world::component::cell::Cell{
            ...
            row.push(my_world::component::cell::Cell{
        ...
        let mut first_row:Vec<my_world::component::cell::Cell>= Vec::new();
        let mut last_row:Vec<my_world::component::cell::Cell>= Vec::new();
        ...
        for col in 0..new_cols {
            first_row.push( my_world::component::cell::Cell{
                position: Vec3::new(new_x_first + (14.85 * col as f32), first_y, 0.1),
                entity: None,
                asigned: false,
                uuid: Uuid::new_v4(),
            });
            last_row.push( my_world::component::cell::Cell{
    ...
    pub fn get_free_cell(&mut self)-> &my_world::component::cell::Cell
    {
        use rand::rng;
